  ...
  const handleSendMail = async (e: MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (typeof err === 'object' && err !== null) {
        const candidate = err as { response?: { data?: { message?: unknown } }; message?: unknown };
        if (candidate.response && candidate.response.data && typeof candidate.response.data.message === 'string') {
          msg = candidate.response.data.message;
